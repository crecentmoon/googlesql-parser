...
1. In your TiDB repository, execute the `replace` instruction to make your parser changes take effect:
    ...
    ```
    GO111MODULE=on go mod edit -replace github.com/crecentmoon/googlesql-parser=github.com/your-repo/parser@your-branch
    ```
...
```
GO111MODULE=on go get -u github.com/crecentmoon/googlesql-parser@master
```
