...
import (
	...
	"github.com/crecentmoon/googlesql-parser/opcode"
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	table := []testCase{
		...
		// for https://github.com/crecentmoon/googlesql-parser/issues/963
...
// For issue #51
// See https://github.com/crecentmoon/googlesql-parser/pull/51 for details
...
// See https://github.com/crecentmoon/googlesql-parser/issue/94
...
// See https://github.com/crecentmoon/googlesql-parser/issue/95
